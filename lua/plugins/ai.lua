return {
  {
    ...
    config = function()
      require('gp').setup {
        ...
        hooks = {
          ...
          Comments = function(gp, params)
            local template = 'I have the following code from {{filename}}:\n\n'
              .. '```{{filetype}}\n{{selection}}\n```\n\n'
              .. 'Please suggest code documentation.'
            local agent = gp.get_chat_agent()
            gp.Prompt(params, gp.Target.vnew 'markdown', nil, agent.model, template, agent.system_prompt)
          end,
        },
      ...
      require('which-key').register({
        ...
        ['<leader>z'] = {
          name = '+[AI]',
          n = { ":<C-u>'<,'>GpChatNew popup<cr>", 'New Chat' },
          p = { ":<C-u>'<,'>GpChatPaste popup<cr>", 'Paste Selection to Chat' },
          ...
          c = {
            ...
            u = { ":<C-u>'<,'>GpUnitTests<cr>", 'Unit Tests' },
            e = { ":<C-u>'<,'>GpExplain<cr>", 'Explain Code' },
            c = { ":<C-u>'<,'>GpCodeReview<cr>", 'Code Review' },
            o = { ":<C-u>'<,'>GpComments<cr>", 'Comments'}
          },
          g = {
            name = 'generate into new ..',
            p = { ":<C-u>'<,'>GpPopup<cr>", 'Popup' },
            e = { ":<C-u>'<,'>GpEnew<cr>", 'Window' },
            n = { ":<C-u>'<,'>GpNew<cr>", 'Horizontal Split' },
            v = { ":<C-u>'<,'>GpVnew<cr>", 'Vertical Split' },
            t = { ":<C-u>'<,'>GpTabnew<cr>", 'Tab' },
          },

          a = { '<cmd>GpNextAgent<cr>', 'Next Agent' },
          s = { '<cmd>GpStop<cr>', 'GpStop' },
          x = { ":<C-u>'<,'>GpContext<cr>", 'Edit Project-wise Context' },
      ...
      require('which-key').register({
        ['<leader>z'] = {
          ...
          b = { '<cmd>GpBufferChatNew<cr>', 'New Chat With Current Buffer' },
          ...
          g = {
            ...
            e = { '<cmd>GpEnew<cr>', 'Window' },
            n = { '<cmd>GpNew<cr>', 'Horizontal Split' },
            v = { '<cmd>GpVnew<cr>', 'Vertial Split' },
            t = { '<cmd>GpTabnew<cr>', 'Tab' },
          },

          a = { '<cmd>GpNextAgent<cr>', 'Next Agent' },
          s = { '<cmd>GpStop<cr>', 'GpStop' },
          x = { '<cmd>GpContext<cr>', 'Edit Project-wise Context' },
          d = { '<cmd>GpChatDelete<cr>', 'Delete Current Chat' },
          e = { '<cmd>GpChatRespond<cr>', 'Regenerate Response' },
