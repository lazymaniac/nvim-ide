    ...
    opts = function()
      ...
      local opts = {
        ...
        config = {
          ...
          shortcut = {
            { icon = ' ', group = '@attribute', desc = 'Projects', action = 'Telescope projects', key = 'p' },
            { icon = '󰱼 ', group = '@constructor.lua', desc = 'Find Files', action = 'Telescope find_files', key = 'f' },
            { icon = '󱎸 ', group = 'rconstructor.lua', desc = 'Find Text', action = 'Telescope live_grep', key = 's' },
