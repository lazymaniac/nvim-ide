  ...
  -- link: https://github.com/Saghen/blink.cmp
  {
    ...
    dependencies = {
      ...
      -- link: https://github.com/L3MON4D3/LuaSnip
      {
        ...
        event = 'InsertEnter',
        dependencies = {
          -- [vscode-angular-snippets] - Angular snippets for LuaSnip
          -- see: `:h vscode-angular-snippets`
          -- link: https://github.com/johnpapa/vscode-angular-snippets/tree/main
          {
      ...
      -- [lazydev.nvim] - Configure Lua libraries for autocompletion
      -- see: `:h lazydev.nvim`
