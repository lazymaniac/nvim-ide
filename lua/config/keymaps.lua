...
map({ 'n', 't' }, '<A-b>', function () Snacks.terminal.toggle("btop --utf-force") end, { desc = 'btop [ab]' })
map({ 'n', 't' }, '<A-u>', function () Snacks.terminal.toggle("ncdu") end, { desc = 'ncdu [au]' })
map({ 'n', 't' }, '<A-d>', function () Snacks.terminal.toggle("lazydocker") end, { desc = 'Lazydocker [ad]' })
