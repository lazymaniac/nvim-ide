...
map({ 'n', 't' }, '<A-c>', function () Snacks.terminal.toggle("cloudlens") end, { desc = 'Cloudlens [A-c]' })
...
map({ 'n', 't' }, '<A-s>', function () Snacks.terminal.toggle("lazysql") end, { desc = 'Lazysql [A-s]' })
...
map({ 'n', 't' }, '<A-f>', function () Snacks.terminal.open() end, { desc = 'New Terminal [A-f]' })
