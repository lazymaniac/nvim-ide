...
map({ 'n', 't' }, '<A-1>', '<cmd>lua require("nvchad.term").toggle {pos = "sp", id = "fl3", cmd = "onefetch"}<cr>', { desc = 'Terminal 1 [a1]' })
map({ 'n', 't' }, '<A-2>', '<cmd>lua require("nvchad.term").toggle {pos = "sp", id = "fl4", cmd = "onefetch"}<cr>', { desc = 'Terminal 2 [a1]' })
map({ 'n', 't' }, '<A-3>', '<cmd>lua require("nvchad.term").toggle {pos = "sp", id = "fl5", cmd = "onefetch"}<cr>', { desc = 'Terminal 3 [a1]' })
map({ 'n', 't' }, '<A-4>', '<cmd>lua require("nvchad.term").toggle {pos = "sp", id = "fl6", cmd = "onefetch"}<cr>', { desc = 'Terminal 4 [a1]' })
map({ 'n', 't' }, '<A-5>', '<cmd>lua require("nvchad.term").toggle {pos = "sp", id = "fl7", cmd = "onefetch"}<cr>', { desc = 'Terminal 5 [a1]' })
--
