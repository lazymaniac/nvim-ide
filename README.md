...
- on Windows (cmd)
```
git clone https://github.com/lazymaniac/nvim-ide.git %userprofile%\AppData\Local\nvim\ 
```

- on Windows (powershell)
```
git clone https://github.com/lazymaniac/nvim-ide.git $env:USERPROFILE\AppData\Local\nvim\ 
```
